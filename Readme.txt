...
- Auto-speed detection for the ISP programming clock.
...
J2 Jumper for firmware upgrade (not self-upgradable)
   ...
   programmer.
J3 SCK option
   If the target clock is very low then you can set this jumper.
   Then SCK is scaled down from 3 MHz to about 8 kHz, but auto-speed
